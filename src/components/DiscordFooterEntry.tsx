...
export function DiscordFooterEntry({
  ...
  if (variant === "spotlight") {
    return (
      <div
        className={clsx(
          "relative overflow-hidden rounded-[28px] p-px bg-white dark:bg-card border dark:border-border",
          className
        )}
        style={{
      ...
      >
        {/* Main card */}
        <div className="relative overflow-hidden rounded-[27px] p-6 sm:p-8 bg-white dark:bg-card border border-white dark:border-border">
