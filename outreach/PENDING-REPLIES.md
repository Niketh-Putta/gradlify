...
- I set up tracking link/code after we agree
- Gradlify = between-lessons practice + mocks (not replacing your mock tests)
...
Just checking whether you had a chance to create a Gradlify account for review?

Once you send the email address you used, I’ll activate access on my side. If the 30% referral structure works for you, I’ll then set up your tracking link/code for Eleven Plus Success.
...
Just checking whether you were able to log in and review the 11+ resources?

If everything looks good on your side, I can send your partner link and a short caption for a post. Commission stays at 30% on all payments through your referrals.

If login is still stuck, tell me what you see and I’ll fix it today.
...
Just checking whether the performance-based structure (30% on referral payments) might work for MumFounded, or if it’s not the right fit.
...
| Partner | Email | If they said yes, send |
|---------|-------|----------------------|
| Honest Mum | mum@honestmum.com | Link `?ref=HONESTMUM` + 30% terms |
| A Baby on Board | ababyonboard@gmail.com | Link `?ref=BABYONBOARD` |
| Tutor's 11 Plus | contact@tutors11plus.co.uk | Link `?ref=TUTORS11` |
| Willow Plus | info@willowplus.co.uk | Link `?ref=WILLOW` |
| Slough Tuition | info@sloughtuition.com | Link `?ref=SLOUGHTUITION` |
...
I’ll track signups on my side and pay monthly. Shout if you want a one-page brief or demo video.
...
## Inbox triage (when you open Gmail)

Search these labels/queries and sort **oldest unanswered first**:

1. `subject:(Gradlify OR partnership OR affiliate OR collab)`  
2. `from:(mocktestmasters OR elevenplussuccess OR prlcharrow OR thefrenchiemummy OR mumfoundeduk OR 11plushub)`  
3. Star threads that need your reply · archive “no” and “stop contacting”

---

## After you send

Update `outreach/manual-affiliate-tracker.csv` column `date_replied` and `status`.
