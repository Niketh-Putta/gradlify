...
Gradlify is an 11+ preparation platform for UK Year 4/5 families:

- Thousands of practice questions + structured notes (Maths, English, VR, NVR)
- Timed mocks with performance feedback
...
Parents don't buy "an app." They buy **proof**:

1. Child sits a free mock  
...
## Commercial terms (starting offer)
...
No upfront fee required for affiliate partners. Sponsored video deals discussed separately for larger channels.
...
**Do not say:** Guaranteed pass, replaces tutoring, instant results.
...
1. Create a free account at https://gradlify.com/11-plus (or we activate creator access for you)  
2. 10-minute call to agree terms + your `ref` code  
3. We send your link + optional caption draft  

**Contact:** Niketh · niketh13putta@gmail.com · gradlify.com

*Attached: Gradlify partner overview slides (PPTX)*
