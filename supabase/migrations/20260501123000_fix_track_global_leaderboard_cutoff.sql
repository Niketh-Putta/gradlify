-- Keep the current sprint leaderboard anchored to the announced reset time.
-- The D/W/M UI filters remain presentation controls, but the competition score
-- window starts at Wednesday 29 April 2026 18:30 BST / 17:30 UTC.
