-- Leaderboard scores are derived from correct_answers_all with a fixed floor instant
-- (effective_start). Raising the floor drops all earlier activity from rankings so the
-- board restarts for the current sprint. Keep in sync with SPRINT_START_AT in
-- src/lib/foundersSprint.ts (default 2026-05-14T19:30:00Z) or VITE_SPRINT_START_ISO.
...
AS $$
DECLARE
  effective_start timestamptz := '2026-05-14T19:30:00Z'::timestamptz;
