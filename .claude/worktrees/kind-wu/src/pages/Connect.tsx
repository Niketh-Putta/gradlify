...
export default function Connect() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-3 sm:px-6 py-3 sm:py-4 h-full flex flex-col overflow-x-hidden">
      ...
      <header className="mb-2 sm:mb-3 flex-shrink-0 animate-fade-in">
        <div className="flex items-center justify-between mb-2">
          <div className="flex items-center gap-1.5">
            <div className="w-5 h-5 sm:w-6 sm:h-6 rounded-lg bg-gradient-to-br from-primary to-purple-500 flex items-center justify-center">
              <Users className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-white" />
            </div>
            <span className="text-[10px] sm:text-xs font-medium bg-gradient-to-r from-primary to-purple-500 bg-clip-text text-transparent tracking-tight">Connect</span>
          </div>
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            <div className="text-right">
              <div className="flex items-baseline gap-0.5 justify-end">
                ...
                <span className="text-lg sm:text-xl font-semibold bg-gradient-to-r from-primary to-purple-500 bg-clip-text text-transparent">
                  {globalOptIn && myEntry ? myEntry.rank : '—'}
                </span>
              </div>
              <div className="text-[9px] sm:text-[10px] text-muted-foreground">{periodLabels[period]}</div>
            </div>
            <div className="w-8 h-8 sm:w-9 sm:h-9 rounded-full bg-gradient-to-br from-primary to-purple-500 flex items-center justify-center text-white text-[10px] sm:text-xs font-medium flex-shrink-0">
              You
            </div>
          </div>
        </div>
        ...
        >
          ...
          <div 
            className={cn(
              ...
              globalOptIn ? "bg-gradient-to-r from-primary to-purple-500" : "bg-border"
            )}
          >
            <div 
              className={cn(
        ...
        <div className="mb-2 sm:mb-3 flex-shrink-0 animate-fade-in" style={{ animationDelay: '0.06s' }}>
          <div className="flex items-center justify-between mb-1.5">
            <div className="flex items-center gap-1.5">
              ...
              <span className="bg-gradient-to-r from-primary to-purple-500 text-white text-[9px] sm:text-[10px] font-semibold px-1.5 py-0.5 rounded-full min-w-[14px] text-center">
              ...
              >
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <Button
                    ...
                    disabled={respondingTo === request.request_id}
                    className="flex-1 py-1 rounded-md text-[9px] sm:text-[10px] font-medium h-auto bg-gradient-to-r from-primary to-purple-500 hover:opacity-90"
                  >
                    Yes
                  </Button>
                </div>
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      <Avatar className={cn(
                        ...
                        isYou && "bg-gradient-to-br from-primary to-purple-500",
                        entryIsFriend && !isYou && "ring-2 ring-offset-2 ring-offset-background ring-purple-500"
                      )}>
                        {isYou ? (
                          <AvatarFallback className="bg-gradient-to-br from-primary to-purple-500 text-white text-[11px] font-medium">
                            You
                          </AvatarFallback>
                        ) : (
                          <>
      ...
      {/* Founders' Circle Callout */}
      <section className="mt-6 animate-fade-in">
        <div className="rounded-2xl border border-border/60 bg-card p-5 sm:p-6">
          <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            <div>
              <p className="text-sm font-semibold text-primary">
                {userTrack === "11plus" ? "Sprint 01" : "Sprint 03"}
              </p>
              <h2 className="text-lg sm:text-xl font-semibold text-foreground">
                {userTrack === "11plus" ? "11+ Launch sprint" : "Compete to win cash prizes and a chance at joining the Gradlify founder's circle."}
              </h2>
              {userTrack === "11plus" && (
            ...
            <div className="flex flex-col md:flex-row md:items-center gap-2">
              <Link
                to="/sprint?from=connect"
                className="inline-flex items-center rounded-full bg-primary px-4 py-2 text-sm font-semibold text-white shadow-sm shadow-primary/40 transition hover:bg-primary/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/40"
              >
                Learn more →
              </Link>
            </div>
      ...
      <section className="mt-4 animate-fade-in">
        <div className="rounded-2xl border border-dashed border-foreground/20 bg-gradient-to-br from-[#f6f1ff] to-[#f1f6ff] p-5 sm:p-6 shadow-[0_10px_30px_rgba(99,102,241,0.15)] dark:border-white/10 dark:from-slate-900 dark:to-slate-950 dark:shadow-[0_10px_30px_rgba(15,23,42,0.55)]">
          <div className="flex flex-col gap-2">
            <p className="text-sm font-semibold text-purple-600 uppercase tracking-wide dark:text-indigo-200">Sprint scoring</p>
