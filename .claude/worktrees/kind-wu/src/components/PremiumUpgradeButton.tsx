      ...
      <DropdownMenuContent align="start" className="w-56">
        <DropdownMenuItem onClick={() => handleUpgrade('monthly')}>
          <div className="flex flex-col">
            ...
            <span className="text-sm text-muted-foreground">3 Day Free Trial, then £4.99/month</span>
          </div>
        </DropdownMenuItem>
        <DropdownMenuItem onClick={() => handleUpgrade('annual')}>
          <div className="flex flex-col">
            <span className="font-medium">Annual Plan</span>
            <span className="text-sm text-muted-foreground">3 Day Free Trial, then £39.99/year</span>
          </div>
        </DropdownMenuItem>
      </DropdownMenuContent>
    </DropdownMenu>
