...
export const AuthModal = ({
  ...
  const handleGoogleSignIn = async () => {
    ...
    setLoading(true);
    // Safety valve: reset loading if the browser redirect never fires within 10 s
    ...
    try {
      ...
      // If the SDK returned a URL but didn't navigate (e.g. popup blocked), do it manually
      if (data?.url) {
