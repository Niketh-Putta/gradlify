-- Fix security issue: Recreate view without SECURITY DEFINER (not needed for views)
DROP VIEW IF EXISTS question_events_all;

CREATE VIEW question_events_all AS
...
-- Add search_path to the leaderboard function for security
