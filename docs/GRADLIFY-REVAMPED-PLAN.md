# Gradlify Revamped Plan
## Psychology · funnel · partners vs solo · what to do now

**Owner:** Niketh · **Site:** gradlify.com/11-plus  
**Baseline:** 6 paying subs · ~£121 MRR · 14 June live mock anchor  
**North star:** £10K MRR (~500 subs) by end of 2026  
**Work rate:** 10 hrs/day (realistic, not fantasy)

**Assets:** `outreach/assets/Gradlify-Partner-Overview.pptx` · `outreach/partner-one-pager.md` · `outreach/PARTNER-REPLIES.md`  
**Do-this-now list:** `GRADLIFY-ACTION-SEQUENCE.md` ← **start here for step-by-step**

---

## Voice-first rule (partners)

**Partners say yes on a call, not in email.**
...
|-------|----------------|-----|
| **Now → £500 MRR** | **You + live mocks + warm partners** | You have 6 subs. A 500K-follower creator sent to a leaky funnel = 0 subs + burned bridge. |
| **£500 → £1.5K MRR** | **Small/mid partners + daily content** | Proof exists. Tutors and parent creators will promote when they see mock scores convert. |
| **£1.5K → £10K MRR** | **Partner grid + paid ads + content volume** | Machine runs; large creators become worth a sponsored deal. |

### Do NOT chase “large following” first
...
## Parent psychology (what actually makes them pay)
...
```
Anxiety ("are we behind?")
    → Low-risk try (free mock / free practice)
    → Proof moment (score + weak topics)
    → Fear of gap ("3 areas below benchmark")
    → Relief + action (£19.99 = one tutor hour)
    → Habit (weekly mock, progress chart)
```

### What kills conversion

| Leak | Parent feels | Fix |
|------|--------------|-----|
| GCSE onboarding on 11+ track | “This isn’t for us” | `VITE_APP_TRACK=11PLUS` |
| No score after mock | “Waste of time” | Post-mock parent report screen |
| “2 mocks/day” but 1/day | Distrust | Copy matches product |
| No signup CTA on landing | Friction | Nav + hero CTA |
| `?ref=` ignored | Partner trust wasted | “Recommended by [Name]” on landing |
| Exam readiness off but marketed | Broken promise | Enable or remove from copy |

**Never send creator traffic until these are fixed.** Warm partner emails are fine; paid posts are not.

---

## Revenue path (realistic)

| Date | Paid subs | MRR | What “good” looks like |
|------|-----------|-----|------------------------|
| **14 Jun** | 6 → 15+ enrolled on mock | £121+ | 50+ mock signups, 5+ new paid |
| **30 Jun** | **25** | **~£500** | Funnel fixed, 2 live partners, daily follow-up |
| **31 Jul** | **75** | **~£1,500** | 8 partners live, July co-mock, 1 content hit |
| **31 Oct** | **300** | **~£6,000** | Tutor affiliate grid + ads testing |
| **31 Dec** | **500** | **~£10,000** | Repeatable; partners + mocks + content |

Miss a week → double mock promotion + partner follow-up the next.
...
**June priority:** Engine 1 + 2. Engine 3 at **1 post/day** (repurpose mock clips).
...
|------|-------|--------|-------------|
| Chris (Eleven Plus Success) | tutor@elevenplussuccess.com | Wants trial | Deck + activate when email sent |
| Cecile (Frenchie Mummy) | cecile@thefrenchiemummy.com | Login + brief | Deck + one-pager + fix login |
| Andy (Pinner Road) | prlcharrow@gmail.com | Awaiting yes on 30% | Deck + confirm structure |
...
Sutton 11 Plus (Karen asked to stop).

---

## Deal types (match partner to offer)
...
- [ ] `?ref=` landing line live
- [ ] **14 Jun mock:** 50+ signups target
...
- [ ] Sponsored integrations when MRR >£1.5K
- [ ] **500 subs / £10K MRR**
...
| Metric | Target |
|--------|--------|
| Mock signups | +30/week in June |
| Trial starts | +50/week from June |
| Trial → paid | **25%+** |
| Partner conversations | 3/week |
| Partners signed | +1 every 2 weeks |
| Net new paid subs | +5/week Jun, +15/week Jul+ |
